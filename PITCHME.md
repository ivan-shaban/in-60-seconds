...
- @size[0.5em](проекты меньше по размеру)
- @size[0.5em](быстрее индексация локально и на сервере)
- @size[0.5em](проекты никак не связаны между собой)
- @size[0.5em](работа с клиентом идет просто как со сторонним сервисом без всяких поблажек)
